    ...
    <Flex bg="gray.600" p={50} w="full" alignItems="center" justifyContent="center">
      ...
      >
        <Flex justifyContent="space-between" alignItems="center">
          <chakra.span fontSize="sm" color={useColorModeValue('gray.800', 'gray.400')}>
            Courses and MOOCs
          </chakra.span>
          <chakra.span
        ...
        <Box>
          <chakra.h1 fontSize="lg" fontWeight="bold" mt={2} color={useColorModeValue('gray.800', 'white')}>
            AP® Psychology - Course 5: Health and Behavior
          </chakra.h1>
          <chakra.p fontSize="sm" mt={2} color={useColorModeValue('gray.600', 'gray.300')}>
        ...
        <Box>
          <Flex alignItems="center" mt={2} color={useColorModeValue('gray.700', 'gray.200')}>
            <span>Visit on:</span>
            <Link mx={2} cursor="pointer" textDecor="underline" color={useColorModeValue('brand.600', 'brand.400')}>
              edx.org
            </Link>
            <span>or</span>
            <Link
