...
export type CoachesByTeamQuery = (
  { __typename?: 'Query' }
  & { coachesByTeam?: Maybe<Array<Maybe<(
    { __typename?: 'Coach' }
    & Pick<Coach, 'id' | 'name'>
  )>>> }
);
...
export type ColorSchemeByTeamQuery = (
  { __typename?: 'Query' }
  & { colorSchemeByTeam?: Maybe<(
    { __typename?: 'ColorScheme' }
    & Pick<ColorScheme, 'id' | 'primary' | 'secondary'>
  )> }
);
...
export type ColorSchemesQuery = (
  { __typename?: 'Query' }
  & { colorSchemes?: Maybe<Array<Maybe<(
    { __typename?: 'ColorScheme' }
    & Pick<ColorScheme, 'id' | 'primary' | 'secondary' | 'teamId'>
  )>>> }
);
...
export type PlayersByTeamQuery = (
  { __typename?: 'Query' }
  & { playersByTeam?: Maybe<Array<Maybe<(
    { __typename?: 'Player' }
    & Pick<Player, 'id' | 'name' | 'slug' | 'number' | 'position' | 'height' | 'weight'>
  )>>> }
);
...
export const CoachesByTeamDocument = `
  ...
  coachesByTeam(id: $id) {
    ...
    `
export const useCoachesByTeamQuery = <
      TData = CoachesByTeamQuery,
      TError = unknown
    >(
      client: GraphQLClient, 
...
export const ColorSchemeByTeamDocument = `
  ...
  colorSchemeByTeam(id: $id) {
    ...
    `
export const useColorSchemeByTeamQuery = <
      TData = ColorSchemeByTeamQuery,
      TError = unknown
    >(
      client: GraphQLClient, 
...
export const ColorSchemesDocument = `
  ...
  colorSchemes {
    ...
    `
export const useColorSchemesQuery = <
      TData = ColorSchemesQuery,
      TError = unknown
    >(
      client: GraphQLClient, 
...
export const PlayersByTeamDocument = `
  ...
  playersByTeam(id: $id) {
    ...
    `
export const usePlayersByTeamQuery = <
      TData = PlayersByTeamQuery,
      TError = unknown
    >(
      client: GraphQLClient, 
